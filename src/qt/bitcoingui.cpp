    ...
    m_network_style(networkStyle)
{
    ...
    progressBar->setStyleSheet("QProgressBar { background-color: #e8e8e8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #000000, stop: 1 " + platformStyle->SingleColor().name() + "); border-radius: 7px; margin: 0px; }");
